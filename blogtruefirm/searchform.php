...
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label for="search-field">
		...
		<input type="search" id="search-field" class="search-field" <?php echo $autocomplete_attr; ?> <?php echo esc_attr( $astra_search_data_attrs ); ?> placeholder="Latest Blogs & Categories" value="<?php echo esc_attr( $astra_search_input_value ); ?>" name="s" tabindex="-1">
